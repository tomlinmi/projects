...
module.exports = {
  ...
  update: [asyncErrorBoundary(restaurantExists), asyncErrorBoundary(update), hasRequiredProperties, hasOnlyValidProperties, update ],
  delete: [asyncErrorBoundary(restaurantExists), asyncErrorBoundary(destroy), destroy],
};
