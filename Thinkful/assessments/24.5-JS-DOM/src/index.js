...
*/
//the div class with ratings rating stat, can access value from either  .rating or .rating.stat space between .rating.stat and  .value or .rating and .value
...
*/
//half star is a class to access with .half.star   note .star to close the space
...
*/
const established = document.querySelector("#ganp .stats .value");
